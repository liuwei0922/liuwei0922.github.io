...
#### 球坐标系
三个方向都是在变化的量，但是三个方向都是垂直的，具体图是：

<img src="https://link.jscdn.cn/sharepoint/aHR0cHM6Ly9jdW10ZWR1Y24tbXkuc2hhcmVwb2ludC5jb20vOmk6L2cvcGVyc29uYWwvbGl1d2VpMDkyMl9jdW10X2VkdV9jbi9FYjBhUk1jTDNBSk5tdUlqaHdnY0VFWUJVUmQzMjE1MmRmVDg0NVEzaUltZlBBP2U9T1VvTHRO.png" width = "300" height = "300" div align= "center" />

位置的表示：
$$\vec r=r\cdot\vec {e_{r}} $$
速度的表示：
$$\vec v=\dot{\vec
r}=\dot{r}\vec{e_r}+r\dot{\theta}\vec{e_{\theta}}+r\dot{\varphi}\sin\theta
\vec{e_{\varphi}}$$
加速度的表示：
$$\vec a=(\ddot{r}-r\dot{\theta}^2-r\dot{\varphi}^2\sin^2\theta)\vec{e_r}+(2\dot{r}\dot{\theta}+r\ddot{\theta}-r\dot{\varphi}\sin\theta\cos\theta) \vec{e_{\theta}}+(2\dot{r}\dot{\varphi}\sin\theta+2r\dot{\theta}\dot{\varphi}\cos\theta+r\ddot{\varphi}\sin\theta)\vec{e_{\varphi}}$$
...
$$W=\vec F\cdot \Delta\vec r=\vec F|\Delta r|\cos\theta$$
